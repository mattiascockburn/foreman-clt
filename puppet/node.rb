...
SETTINGS = {
  :url          => "https://foreman.demo.int",  # e.g. https://foreman.example.com
  ...
  :ssl_cert     => "/var/lib/puppet/ssl/certs/foreman.demo.int.pem",    # e.g. /var/lib/puppet/ssl/certs/FQDN.pem
  :ssl_key      => "/var/lib/puppet/ssl/private_keys/foreman.demo.int.pem"      # e.g. /var/lib/puppet/ssl/private_keys/FQDN.pem
}
